...
def data(dtf="5m"):
    ...
    m1 = pd.read_parquet("/home/user/quant/data/fut_1m.parquet")
    m1 = m1[m1.dt >= "2020-06-01"].reset_index(drop=True)
    d = pd.read_parquet(f"/home/user/quant/data/fut_{dtf}.parquet")
    ...
    fu = pd.read_parquet("/home/user/quant/data/funding.parquet")
